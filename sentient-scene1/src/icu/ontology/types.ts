...
//  vocabulary shared across the Sentient layers:
//    PLEXUS — the SIGNAL layer (device feeds, LIS, PACS, EMR read/write). It
...
//  TARS and iSAM are the two agents, and neither is railed to a room or a
//  function — either does whatever a beat needs.
//
