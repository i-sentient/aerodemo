...
export const tarsConfirmTex = make(760, 168, (c) => {
  ...
  c.fillText('is object Chandrababu · 58 M · probable MI?', w / 2, h / 2 + 26)
  c.textAlign = 'left'
})
...
// --- bedside SAM console · beat 6: analysis done → OMI, admit ---------------
export const samStemiTex = make(560, 350, (c) => {
  ...
  // diagnosis — the OMI (red, prominent)
  c.textBaseline = 'middle'
  c.fillStyle = '#ff5a5a'
  c.beginPath(); c.arc(52, 148, 9, 0, Math.PI * 2); c.fill()
  c.fillStyle = '#ff8080'
  c.font = 'bold 34px system-ui, sans-serif'
  c.fillText('Anterior OMI', 82, 146)
  c.fillStyle = '#9aa7b2'
  c.font = '17px system-ui, sans-serif'
