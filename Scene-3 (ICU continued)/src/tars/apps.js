...
export function initApps() {
  onModeChange((mode) => {
    ...
    buildDock(); openApp(mode === 'patient' ? 'pacs' : dockApps()[0]); // Scene 3: patient opens on PACS (imaging)
  });
