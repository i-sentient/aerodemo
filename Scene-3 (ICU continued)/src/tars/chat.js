...
function patientScript(b) {
  // ── SCENE 3 · post-CT-angio continuation ──────────────────────────────────
  // Opens straight on the patient: body = vascular, right split = PACS (the CT
  // angiogram), and LSam leads with the study being complete. Further beats to
  // be scripted card-by-card with Yeshwanth.
